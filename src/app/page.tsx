            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
                {projects.map((project, index) => (
                  ...
                  >
                    <Card className="border-0 shadow-none bg-transparent hover:bg-black/3 transition-all duration-400 h-full">
                      <CardContent className="p-4 sm:p-6 md:p-8">
                        {/* Number indicator */}
                        <div className="mb-6">
                          <div className="w-16 h-16 border-2 border-black/10 rounded-full flex items-center justify-center group-hover:border-black/30 transition-colors">
                        ...
                        {/* Technologies */}
                        <p className="text-xs font-light uppercase tracking-wider opacity-50 mb-6">
                        ...
                        <ul className="space-y-3 mb-8">
                          {project.achievements.map((achievement, achIndex) => (
                            <li key={achIndex} className="text-xs font-light leading-relaxed opacity-70">
                              {achievement}
                            </li>
                          ))}
                        </ul>
                        ...
                        <div className="flex justify-end">
                          <motion.div 
                            className="w-8 h-8 border border-black/20 rounded-full flex items-center justify-center"
