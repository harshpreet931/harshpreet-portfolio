...
const SOCIALS = [
  ...
  },
  {
    ...
    label: 'Medium',
    path: 'M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75S24 8.83 24 12z',
  },
];
    ...
    <header className="relative z-10 flex justify-between items-start w-full mb-[5vh] max-sm:flex-wrap max-sm:gap-3">
      ...
      <nav className="flex items-center gap-4 flex-1 justify-center max-sm:flex-none max-sm:w-full max-sm:justify-start">
        ...
        <Link
          ...
          className={`${navCls} ${pathname?.startsWith('/blog') ? '!opacity-100' : ''}`}
      ...
      <div className="flex justify-end items-center gap-3 flex-1 max-sm:w-full max-sm:justify-start">
